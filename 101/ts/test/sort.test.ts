...
describe('Sort', () => {
  ...
  const sorted = [
    ...
    30, 33, 33, 33, 33, 33, 34, 35, 35, 36, 36, 38, 38, 40, 41, 42, 42, 44, 48,
    50, 51, 51, 54, 54, 54, 54, 55, 55, 55, 56, 56, 56, 57, 57, 58, 60, 61, 61,
    61, 63, 65, 65, 65, 66, 66, 66, 67, 68, 72, 72, 75, 76, 77, 77, 77, 81, 82,
    83, 84, 84, 84, 85, 85, 90, 91, 91, 91, 92, 93, 93, 94, 94, 95, 95, 96, 97,
    98, 99, 100, 100, 100,
  ];
  ...
  test('should sort with selection sort', () => {
    const input = structuredClone(values);
    selectionSort(input);
    expect(input).toEqual(sorted);
  });

  test('should sort with insertion sort', () => {
    const input = structuredClone(values);
    insertionSort(input);
    expect(input).toEqual(sorted);
  });

  test('should sort with merge sort', () => {
    expect(mergeSort(values)).toEqual(sorted);
  });

  test('should sort with quick sort', () => {
    const input = structuredClone(values);
    quickSort(input);
    expect(input).toEqual(sorted);
  });
